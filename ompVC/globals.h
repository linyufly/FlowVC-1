...
extern int 					opt_num;
extern int					outputframe;

extern int					LOWERLOOP;
extern int					UPPERLOOP;

extern int 					TRACER_LOWERLOOP;
extern int 					TRACER_UPPERLOOP;

extern int 					num_threads;

//extern FILE 				*Trace_BinFileID;
...
extern StaggeredPoint		**Trace_Staggered_Launch;
extern int					*Points;
extern int					max;
extern int       	      	**Trace_NumOutput_OMP;
